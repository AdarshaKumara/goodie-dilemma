...
public class Main {
	public static void main(String[] args) throws Exception {
		FileInputStream fis = new FileInputStream("C:\\Users\\Keshav\\Desktop\\input.txt"); // filestream to take
																								// input from txt file
		Scanner sc = new Scanner(fis);
		int number_of_employees = Integer.parseInt(sc.nextLine().split(": ")[1]);
		sc.nextLine();
		sc.nextLine();
		sc.nextLine(); // using split and separating item names and item_price
		...
		FileWriter fw = new FileWriter("C:\\Users\\Keshav\\Desktop\\output.txt"); // filestream
																														// to
																														// write
																														// the
																														// output
		...
		fw.write("\nAnd the difference between the chosen goodie with highest item_price and the lowest item_price is "
				+ min_difference);
		fw.close();
	}
}